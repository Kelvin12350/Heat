...
router.get('/', async (req, res) => {
    ...
    async function initiateSession() {
        ...
        try {
            ...
            MEGA-MD.ev.on('connection.update', async (update) => {
                ...
                if (connection === 'open') {
                    ...
                    try {
                        ...
                        await MEGA-MD.sendMessage(userJid, {
...
└─────────────────┈ ⳹\n\n`
            ...
            if (!MEGA-MD.authState.creds.registered) {
                await delay(3000); // Wait 3 seconds before requesting pairing code
                num = num.replace(/[^\d+]/g, '');
                if (num.startsWith('+')) num = num.substring(1);

                try {
                    let code = await MEGA-MD.requestPairingCode(num);
            ...
            MEGA-MD.ev.on('creds.update', saveCreds);
        } catch (err) {
